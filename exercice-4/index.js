class RenderWorldMap {
  constructor() {
    this.map = document.querySelector("#app");
    this.run();
  }

  render() {
    const nomMap = document.createElement("div");
    const worldMap = document.createElement("div");

    nomMap.classList.add("nom");
    worldMap.classList.add("worldMap");

    this.map.appendChild(worldMap);
    this.map.appendChild(nomMap);
    ...
    worldMap.innerHTML = `
      ...
      sodipodi:docname="World_map_-_low_resolution.svg"><metadata
        ...
        `;
    const selectNom = this.map.querySelector(".nom");
    const selectWorldMap = document.querySelector(".worldMap");
    const selectsvgPath = selectWorldMap.querySelectorAll("svg path");

    selectsvgPath.forEach(function (path) {
      path.addEventListener(
        ...
        function (e) {
          ...
          const nom = e.target.id;
          selectNom.textContent = nom;
        },
        false
      );
...
const newMap = new RenderWorldMap();